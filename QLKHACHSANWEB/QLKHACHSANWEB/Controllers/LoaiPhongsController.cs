...
namespace QLKHACHSANWEB.Controllers
{
    public class LoaiPhongsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LoaiPhongId,TenLoai")] LoaiPhong loaiPhong)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LoaiPhongId,TenLoai")] LoaiPhong loaiPhong)
        {
            if (ModelState.IsValid)
            {
