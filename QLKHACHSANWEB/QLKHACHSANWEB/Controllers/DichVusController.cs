...
namespace QLKHACHSANWEB.Controllers
{
    public class DichVusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DichVuId,DichVuName,Gia")] DichVu dichVu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DichVuId,DichVuName,Gia")] DichVu dichVu)
        {
            if (ModelState.IsValid)
            {
